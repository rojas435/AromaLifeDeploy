...
describe('ComplementaryProductService', () => {
  ...
  describe('create', () => {
    it('should create a new complementary product', async () => {
      const createDto = { name: 'New Product', price: 10.5, quantity: 5 };
  ...
  describe('findOne', () => {
    it('should return a complementary product by ID', async () => {
      const mockProduct = { id: 1, name: 'Product 1', price: 10.5, quantity: 5 };
  ...
  describe('update', () => {
    it('should update a complementary product', async () => {
      const updateDto = { name: 'Updated Product', price: 15.0, quantity: 10 };
      const mockProduct = { id: 1, name: 'Old Product', price: 10.5, quantity: 5 };
  ...
  describe('remove', () => {
    it('should remove a complementary product', async () => {
      const mockProduct = { id: 1, name: 'Product to Delete', price: 10.5, quantity: 5 };
