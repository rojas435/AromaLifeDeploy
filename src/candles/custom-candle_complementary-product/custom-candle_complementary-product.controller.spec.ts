...
describe('CustomCandleComplementaryProductController', () => {
  ...
  describe('update', () => {
    it('should update a CustomCandleComplementaryProduct', async () => {
    ...
    it('should throw an error if CustomCandleComplementaryProduct to update is not found', async () => {
      ...
      mockService.update.mockRejectedValue(new NotFoundException('CustomCandleComplementaryProduct with id 1 not found'));

      await expect(controller.update(1, updateDto)).rejects.toThrow('CustomCandleComplementaryProduct with id 1 not found');
      expect(service.update).toHaveBeenCalledWith(1, updateDto);
    });
  });
