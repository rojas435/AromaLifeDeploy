...
describe('CustomCandleComplementaryProductService', () => {
  ...
  describe('update', () => {
    it('should update a CustomCandleComplementaryProduct successfully', async () => {
      const updateDto = { customCandleId: 'uuid-candle-updated', complementaryProductId: 2 };
      const mockCustomCandle = { id: 'uuid-candle-updated' } as CustomCandle;
      const mockComplementaryProduct = { id: 2 } as ComplementaryProduct;
      const mockEntity = {
        id: 1,
    ...
    it('should throw an error if CustomCandleComplementaryProduct to update is not found', async () => {
      repository.findOne.mockResolvedValue(null);

      await expect(service.update(1, { customCandleId: 'uuid-candle-updated', complementaryProductId: 2 })).rejects.toThrow(
        'CustomCandleComplementaryProduct with id 1 not found',
      );
    });
  });
