...
import { UpdateEmotionalStateFragranceDto } from './dto/update-emotional-state_fragrance.dto';
...
export class EmotionalStateFragranceService {
  ...
  async update(
    ...
    fragranceId: string,
    updateEmotionalStateFragranceDto: UpdateEmotionalStateFragranceDto,
  ): Promise<EmotionalStateFragrance> {
    const emotionalStateFragrance = await this.findByEmotionalStateAndFragranceId(
      emotionalStateId,
      fragranceId,
    );
  
    Object.assign(emotionalStateFragrance, updateEmotionalStateFragranceDto);
  
    return this.emotionalStateFragranceRepository.save(emotionalStateFragrance);
  }
